...
const clivalue_t valueTable[] =
{
    ...
    { "hdfreeangle",               VAR_INT8,   &cfg.hdfreeangle,               -30,         30, 1 },
    ...
    { "gps_ph_minbrakeangle",      VAR_UINT8,  &cfg.gps_ph_minbrakeangle,        1,         99, 1 },
    { "gps_ph_forcetimeout",       VAR_UINT16, &cfg.gps_ph_forcetimeout,      1000,      10000, 1 },
