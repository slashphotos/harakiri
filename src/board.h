...
#define RADX M_PI / 180.0f                                   // Crashpilot 0.017453292519f
#define RADX10 M_PI / 1800.0f                                // Crashpilot 0.001745329252f
#define RADX100 M_PI / 18000.0f                              // Crashpilot 0.000174532925f
...
{
    uint32_t ut_delay;   																		// Crashpilot Changed to 32 Bit
    uint32_t up_delay;   																		// Crashpilot Changed to 32 Bit
    uint32_t repeat_delay;   																// Crashpilot Changed to 32 Bit
