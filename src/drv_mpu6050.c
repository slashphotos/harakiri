...
static void mpu6050TempRead(int16_t * tempData);
...
static void mpu6050TempRead(int16_t *tempData)
{
    ...
    *tempData = ((int16_t)(buf[0] << 8 | buf[1])) / 340 + 37; //Temperature in degrees C = (TEMP_OUT Register Value as a signed quantity)/340 + 36.53
}
...
static void mpu6050GyroInit(void)
{
    ...
    case 5:
        DLPFCFG = 6;
        break;
    default:                                                  // User fucked it up, take 42Hz
        DLPFCFG = 3;
        break;
    }
